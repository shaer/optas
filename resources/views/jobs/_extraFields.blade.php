            ...
            <div class="panel-body">
                <div class="db_action">
                    <div class="form-group">
                        ...
                        {{ Form::select('actions[generatedId][triggerable][connection_id]', $connections, null, ['class' => 'form-control', 'placeholder' => 'Select Database Connection']) }}
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::textarea ('actions[generatedId][triggerable][query]', null, ['class' => 'form-control']) }}
